module github.com/teonet-go/truproxy/tru/client

go 1.23.4

require (
	github.com/teonet-go/teogw v0.6.7
	github.com/teonet-go/teowebrtc_server v0.1.0
...
require (
	...
	github.com/teonet-go/teowebrtc_client v0.0.16 // indirect
	github.com/teonet-go/teowebrtc_log v0.0.1 // indirect
	github.com/teonet-go/teowebrtc_signal v0.0.8 // indirect
	github.com/teonet-go/teowebrtc_signal_client v0.0.10 // indirect
